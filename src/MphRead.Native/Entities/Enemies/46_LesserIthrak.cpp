...
namespace MphRead::Entities::Enemies
{
    ...
    {
        if (!_warnVolume.TestPoint(RequireReference(PlayerEntity::Main()).Position))
        {
            return false;
        }
        SetNodeAnim(6);
    ...
    {
        if (!_rangeVolume.TestPoint(RequireReference(PlayerEntity::Main()).Position))
        {
            return false;
        }
        PickMoveTarget(_homeVolume);
