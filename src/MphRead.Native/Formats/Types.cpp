...
namespace
{
    ...
    std::int32_t CombineHashCodes(std::initializer_list<std::int32_t> values)
    {
    ...
    std::int32_t ParseHexInt32(std::string_view value)
    {
        ...
        if (error == std::errc::result_out_of_range || parsed > std::numeric_limits<std::uint32_t>::max())
        {
    ...
    std::string RemoveLowercaseHexPrefixes(std::string_view value)
    {
    ...
    std::int32_t TruncateToInt32Unchecked(float value) noexcept
    {
...
namespace MphRead
{
    ...
    LightInfo& LightInfo::operator=(const LightInfo& other) noexcept
    {
        ...
        {
            this->~LightInfo();
            ::new (static_cast<void*>(this)) LightInfo(other);
        }
        return *this;
    }
    ...
    Fixed& Fixed::operator=(const Fixed& other) noexcept
    {
        ...
        {
            this->~Fixed();
            ::new (static_cast<void*>(this)) Fixed(other);
        }
        return *this;
    }
    ...
    {
        return static_cast<float>(std::bit_cast<std::int32_t>(value)) / static_cast<float>(1 << 12);
    }
    ...
    {
        return TruncateToInt32Unchecked(value * 4096.0F);
    }
    ...
    Vector3Fx& Vector3Fx::operator=(const Vector3Fx& other) noexcept
    {
        ...
        {
            this->~Vector3Fx();
            ::new (static_cast<void*>(this)) Vector3Fx(other);
        }
        return *this;
    }
    ...
    {
        return OpenTK::Mathematics::Vector3(X.FloatValue(), Y.FloatValue(), Z.FloatValue());
    }
    ...
    Vector4Fx& Vector4Fx::operator=(const Vector4Fx& other) noexcept
    {
        ...
        {
            this->~Vector4Fx();
            ::new (static_cast<void*>(this)) Vector4Fx(other);
        }
        return *this;
    }
    ...
    {
        return OpenTK::Mathematics::Vector4(X.FloatValue(), Y.FloatValue(), Z.FloatValue(), W.FloatValue());
    }
    ...
    Matrix43Fx& Matrix43Fx::operator=(const Matrix43Fx& other) noexcept
    {
        ...
        {
            this->~Matrix43Fx();
            ::new (static_cast<void*>(this)) Matrix43Fx(other);
        }
        return *this;
    }
    ...
    Matrix44Fx& Matrix44Fx::operator=(const Matrix44Fx& other) noexcept
    {
        ...
        {
            this->~Matrix44Fx();
            ::new (static_cast<void*>(this)) Matrix44Fx(other);
        }
        return *this;
    }
    ...
    OpenTK::Mathematics::Matrix4 Matrix44Fx::ToFloatMatrix() const noexcept
    {
        return OpenTK::Mathematics::Matrix4(
            One.ToFloatVector(), Two.ToFloatVector(), Three.ToFloatVector(), Four.ToFloatVector());
    }
        ...
        OpenTK::Mathematics::Vector3 vector1, OpenTK::Mathematics::Vector3 vector2)
    {
        ...
        Vector3 direction = Vector3::Cross(vector1, up);
        Matrix3 transform{};
        transform.M11 = up.X; transform.M12 = up.Y; transform.M13 = up.Z;
        transform.M21 = direction.X; transform.M22 = direction.Y; transform.M23 = direction.Z;
        transform.M31 = vector1.X; transform.M32 = vector1.Y; transform.M33 = vector1.Z;
        return transform;
    }
        ...
        OpenTK::Mathematics::Vector3 position)
    {
        ...
        transform.M21 = direction.X; transform.M22 = direction.Y; transform.M23 = direction.Z;
        transform.M31 = vector1.X; transform.M32 = vector1.Y; transform.M33 = vector1.Z;
        transform.M41 = position.X; transform.M42 = position.Y; transform.M43 = position.Z;
        transform.M44 = 1.0F;
        return transform;
    }
    ...
    {
        OpenTK::Mathematics::Matrix4x3 output{};
    ...
    {
        OpenTK::Mathematics::Matrix4 output{};
        output.M11 = first.M13 * second.M31 + first.M11 * second.M11 + first.M12 * second.M21;
        output.M12 = first.M13 * second.M32 + first.M11 * second.M12 + first.M12 * second.M22;
        output.M21 = first.M23 * second.M31 + first.M21 * second.M11 + first.M22 * second.M21;
        output.M22 = first.M23 * second.M32 + first.M21 * second.M12 + first.M22 * second.M22;
    ...
    float Matrix::ProjectPosition(OpenTK::Mathematics::Vector3 pos,
    ...
    void Matrix::GetProjectedValues(OpenTK::Mathematics::Vector3 pos,
    ...
    ColorRgb& ColorRgb::operator=(const ColorRgb& other) noexcept
    {
        ...
        {
            this->~ColorRgb();
            ::new (static_cast<void*>(this)) ColorRgb(other);
        }
        return *this;
    }
    ...
    {
        return OpenTK::Mathematics::Vector3(Red / 255.0F, Green / 255.0F, Blue / 255.0F);
    }

    OpenTK::Mathematics::Vector4 ColorRgb::AsVector4(float alpha) const noexcept
    {
        return OpenTK::Mathematics::Vector4(Red / 255.0F, Green / 255.0F, Blue / 255.0F, alpha);
    }

    OpenTK::Mathematics::Vector3 operator/(ColorRgb left, float right) noexcept
    {
        return OpenTK::Mathematics::Vector3(left.Red / right, left.Green / right, left.Blue / right);
    }

    bool ColorRgb::Equals(const std::any& obj) const
    {
        const ColorRgb* other = std::any_cast<ColorRgb>(&obj);
        return other != nullptr && Red == other->Red && Green == other->Green && Blue == other->Blue;
    }
    ...
    ColorRgba::ColorRgba(std::uint32_t value, std::uint8_t alpha) noexcept
        : Red(static_cast<std::uint8_t>(std::round(static_cast<float>((value >> 0) & 0x1FU) / 31.0F * 255.0F))),
          Green(static_cast<std::uint8_t>(std::round(static_cast<float>((value >> 5) & 0x1FU) / 31.0F * 255.0F))),
          Blue(static_cast<std::uint8_t>(std::round(static_cast<float>((value >> 10) & 0x1FU) / 31.0F * 255.0F))),
          Alpha(alpha)
    {
    }
    ...
    ColorRgba& ColorRgba::operator=(const ColorRgba& other) noexcept
    {
        ...
        {
            this->~ColorRgba();
            ::new (static_cast<void*>(this)) ColorRgba(other);
        }
        return *this;
    }
    ...
    {
        const ColorRgba* other = std::any_cast<ColorRgba>(&obj);
        return other != nullptr && Red == other->Red && Green == other->Green
    ...
    OpenTK::Mathematics::Vector2 TypeExtensions::WithX(OpenTK::Mathematics::Vector2 vector, float x) noexcept { return {x, vector.Y}; }
    OpenTK::Mathematics::Vector2 TypeExtensions::WithY(OpenTK::Mathematics::Vector2 vector, float y) noexcept { return {vector.X, y}; }
    OpenTK::Mathematics::Vector2 TypeExtensions::AddX(OpenTK::Mathematics::Vector2 vector, float x) noexcept { return {vector.X + x, vector.Y}; }
    OpenTK::Mathematics::Vector2 TypeExtensions::AddY(OpenTK::Mathematics::Vector2 vector, float y) noexcept { return {vector.X, vector.Y + y}; }
    OpenTK::Mathematics::Vector3 TypeExtensions::WithX(OpenTK::Mathematics::Vector3 vector, float x) noexcept { return {x, vector.Y, vector.Z}; }
    OpenTK::Mathematics::Vector3 TypeExtensions::WithY(OpenTK::Mathematics::Vector3 vector, float y) noexcept { return {vector.X, y, vector.Z}; }
    OpenTK::Mathematics::Vector3 TypeExtensions::WithZ(OpenTK::Mathematics::Vector3 vector, float z) noexcept { return {vector.X, vector.Y, z}; }
    OpenTK::Mathematics::Vector3 TypeExtensions::AddX(OpenTK::Mathematics::Vector3 vector, float x) noexcept { return {vector.X + x, vector.Y, vector.Z}; }
    OpenTK::Mathematics::Vector3 TypeExtensions::AddY(OpenTK::Mathematics::Vector3 vector, float y) noexcept { return {vector.X, vector.Y + y, vector.Z}; }
    OpenTK::Mathematics::Vector3 TypeExtensions::AddZ(OpenTK::Mathematics::Vector3 vector, float z) noexcept { return {vector.X, vector.Y, vector.Z + z}; }

    OpenTK::Mathematics::Vector3i TypeExtensions::ToFixedVector(OpenTK::Mathematics::Vector3 vector) noexcept
    {
        return {Fixed::ToInt(vector.X), Fixed::ToInt(vector.Y), Fixed::ToInt(vector.Z)};
    }

    Vector3Fx TypeExtensions::ToVector3Fx(OpenTK::Mathematics::Vector3 vector) noexcept
    {
        return Vector3Fx(Fixed::ToInt(vector.X), Fixed::ToInt(vector.Y), Fixed::ToInt(vector.Z));
    }

    OpenTK::Mathematics::Vector4 TypeExtensions::WithX(OpenTK::Mathematics::Vector4 vector, float x) noexcept { return {x, vector.Y, vector.Z, vector.W}; }
    OpenTK::Mathematics::Vector4 TypeExtensions::WithY(OpenTK::Mathematics::Vector4 vector, float y) noexcept { return {vector.X, y, vector.Z, vector.W}; }
    OpenTK::Mathematics::Vector4 TypeExtensions::WithZ(OpenTK::Mathematics::Vector4 vector, float z) noexcept { return {vector.X, vector.Y, z, vector.W}; }
    OpenTK::Mathematics::Vector4 TypeExtensions::WithW(OpenTK::Mathematics::Vector4 vector, float w) noexcept { return {vector.X, vector.Y, vector.Z, w}; }
    OpenTK::Mathematics::Vector4 TypeExtensions::AddX(OpenTK::Mathematics::Vector4 vector, float x) noexcept { return {vector.X + x, vector.Y, vector.Z, vector.W}; }
    OpenTK::Mathematics::Vector4 TypeExtensions::AddY(OpenTK::Mathematics::Vector4 vector, float y) noexcept { return {vector.X, vector.Y + y, vector.Z, vector.W}; }
    OpenTK::Mathematics::Vector4 TypeExtensions::AddZ(OpenTK::Mathematics::Vector4 vector, float z) noexcept { return {vector.X, vector.Y, vector.Z + z, vector.W}; }
    OpenTK::Mathematics::Vector4 TypeExtensions::AddW(OpenTK::Mathematics::Vector4 vector, float w) noexcept { return {vector.X, vector.Y, vector.Z, vector.W + w}; }

    OpenTK::Mathematics::Matrix3 TypeExtensions::AsMatrix3(OpenTK::Mathematics::Matrix4x3 matrix) noexcept
    {
        return OpenTK::Mathematics::Matrix3(matrix.Row0(), matrix.Row1(), matrix.Row2());
    }

    OpenTK::Mathematics::Matrix4 TypeExtensions::AsMatrix4(OpenTK::Mathematics::Matrix4x3 matrix) noexcept
    {
        return OpenTK::Mathematics::Matrix4(
    ...
    OpenTK::Mathematics::Matrix4 TypeExtensions::Keep3x3(OpenTK::Mathematics::Matrix4x3 matrix) noexcept
    {
        return OpenTK::Mathematics::Matrix4(
    ...
    OpenTK::Mathematics::Matrix4 TypeExtensions::Keep3x3(OpenTK::Mathematics::Matrix4 matrix) noexcept
    {
        return OpenTK::Mathematics::Matrix4(
