...
namespace MphRead::Mods::Network
{
    ...
    private:
        ...
        std::shared_ptr<::MphRead::NativeRuntime::Stream> _stream;
        std::shared_ptr<::MphRead::NativeRuntime::Stream> _deflate;
    ...
    private:
        DemoReader(std::shared_ptr<::MphRead::NativeRuntime::Stream> stream,
