...
namespace MphRead
{
    const std::string Shaders::VertexShader = R"shader(
#version 120
...
void main()
{
    ...
    const std::string Shaders::FragmentShader = R"shader(
#version 120
uniform bool use_texture;
uniform bool fog_enable;
uniform vec4 fog_color;
...
void main()
{
    ...
    const std::string Shaders::RttFragmentShader = R"shader(
#version 120
...
void main()
{
    ...
    const std::string Shaders::CelFragmentShader = R"shader(
#version 120
...
void main()
{
    ...
    const std::string Shaders::ShiftFragmentShader = R"shader(
#version 120
