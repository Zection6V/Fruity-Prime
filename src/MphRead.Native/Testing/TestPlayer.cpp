...
{
    std::shared_ptr<const TestPlayer::ReadOnlyList<TestPlayer::PlayerControls>> TestPlayer::GetPlayerControls()
    {
        auto items = Utility::Parser::ParseBytes<PlayerControls>(0x9C, 5, std::vector<std::uint8_t>{
0x76, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00,
        ...
        return std::shared_ptr<const ReadOnlyList<PlayerControls>>(
            new ReadOnlyList<PlayerControls>(std::move(items)));
    }

    std::shared_ptr<const TestPlayer::ReadOnlyList<TestPlayer::PlayerValues>> TestPlayer::GetPlayerValues()
    {
        auto items = Utility::Parser::ParseBytes<PlayerValues>(0x168, 8, std::vector<std::uint8_t>{
0xC2, 0x01, 0x00, 0x00, 0xC2, 0x01, 0x00, 0x00, 0xD7, 0x03, 0x00, 0x00, 0xD7, 0x03, 0x00, 0x00,
        ...
        return std::shared_ptr<const ReadOnlyList<PlayerValues>>(
            new ReadOnlyList<PlayerValues>(std::move(items)));
    }
}
