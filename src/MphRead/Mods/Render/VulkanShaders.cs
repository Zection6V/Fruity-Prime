...
void main()
{
    ...
    out_color = col;
        ...
        // Veldrid 4.9 does not expose depth-bias fields on its public
        // rasterizer state. Keep GL_POLYGON_OFFSET_FILL in a separate shader
        // variant instead of making the ordinary scene shader statically write
        // fragment depth. A conditional depth write left ordinary fragment
        // depth undefined on real Vulkan drivers and caused dense z-fighting
        // while software Vulkan happened to look stable.
        public static string SceneOffsetFragment { get; } =
            SceneFragment.Replace(
                "    out_color = col;\n}",
